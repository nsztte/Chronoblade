...
{
    [Header("퍼즐 바늘 설정")]
    [SerializeField] private PuzzleClockManager.HandProgress handProgress;
    [SerializeField] private bool isRight = true;
    [SerializeField] private float rotationSpeed = 60f;
    [SerializeField] private float puzzle1TargetAngle;
    [SerializeField] private float finalPuzzleTargetAngle;
    ...
    private void Update()
    {
        ...
        if(puzzleClockManager.CurrentPhase == BossPhase.FinalPuzzle && puzzleClockManager.CurrentProgress != handProgress) return;
    ...
    public bool IsAligned()
    {
        ...
        float targetAngle = puzzleClockManager.CurrentPhase == BossPhase.Puzzle1 ? puzzle1TargetAngle : finalPuzzleTargetAngle;
